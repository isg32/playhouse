...
buildanduploadbaby()
{
    ...
    ota_from_target_files -k $path/vendor/priv-keys/releasekey $path/cuaosp/out/target/product/hanoip/signed-target-files.zip $path/cuaosp/out/target/product/hanoip/CUAOSP_hanoip-15.0-$CUSTOM_BUILD_DATE-BETA.zip
